...
print(f"Zad 1 - Wartość dysparycji wyznaczonej przez własną metode dla [{x},{y}]: {disp[y][x]}")

matplotlib.pyplot.imshow(ref_disp)
plt.show()
cv.imwrite("Artroom2/Results/Zad 2/ref_disparity.png", ref_disp)
IO.save_disp_to_json(ref_disp, "Artroom2/Results/Zad 2/ref_disparity_data.json")
...
print(f"Zad 2 - Wartość depth wyznaczonej przez własną metodę dla [{x},{y}]: {depth[y][x]}")
