...
depth = api.calculate_depth_with_rgb24(bit24, max_distance)                         # Obliczanie depth na podstawie depth_24bit
...
baseline = 0.6
fov = 120
f = api.calculate_focalX_with_FovW_deg(depth.shape[0], fov)                         # Dane z .txt lub obliczone

disp = api.calculate_disparity_with_depth(depth, f, baseline, 0)                    # Obliczanie disparity na podstawie depth
