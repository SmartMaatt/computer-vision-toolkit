...
if __name__ == "__main__":
    ...
    window = (7, 7)
    direction = toolkit.DispDirection.left_to_right
    # direction = toolkit.DispDirection.right_to_left
    criterium = toolkit.DispCriterium.argmin
    ...
    # disp = toolkit.calculate_disparity(img_left, img_right, ndisp, window, direction, criterium)  # Wypróbuj różne paramerty by uzyskać względnie dobry wynik
    ...
    depth = toolkit.calculate_depth_with_disparity(disp, f, baseline, doffs)
    ref_depth = toolkit.calculate_depth_with_disparity(
